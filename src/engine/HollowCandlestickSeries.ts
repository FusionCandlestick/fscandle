...
const defaultHollowOptions: CandlestickStyleOptions = {
  upColor: '#26a69a',
  downColor: '#ef5350',
  wickVisible: true,
  borderVisible: true,
...
export class HollowCandlestickSeries extends BaseSeries<CandlestickStyleOptions> {
  constructor(options: DeepPartial<CandlestickStyleOptions> = {}) {
    super({ ...defaultHollowOptions, ...options } as CandlestickStyleOptions);
  }
